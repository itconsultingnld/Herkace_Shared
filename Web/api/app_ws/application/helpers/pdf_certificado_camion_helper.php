...
function pdf_certificado_camion($verificacion_id)
{
    $CI = &get_instance();
    $CI->load->database();
    ...
    $CI->F_pdf->SetXY(12, $set_y);
    $CI->F_pdf->Cell(50, 6, $vehiculo->tarjeta_circ, $margenes, 0, 'C', false);
    $CI->F_pdf->Cell(40, 6, $verificacion->kilometraje, $margenes, 0, 'C', false);
    ...
    $CI->F_pdf->Cell(50, 6, utf_decode($verificacion->marca), $margenes, 0, 'C', false);
    $CI->F_pdf->Cell(30, 6, $vehiculo->anio, $margenes, 0, 'C', false);
    ...
    $CI->F_pdf->SetXY(90, $set_y);
    $CI->F_pdf->Cell(65, 6, utf_decode($verificacion->tecnico), $margenes, 0, 'L', false);

    $set_y += 3;

    $CI->F_pdf->SetXY(170, $set_y);
    $CI->F_pdf->SetFont('Arial', '', 14);
    $CI->F_pdf->MultiCell(30, 6, $verificacion->num_placas . "\n" . fecha_formato_dma($verificacion->fecha), $margenes, 'L', false);
    $CI->F_pdf->SetFont('Arial', '', 7);
