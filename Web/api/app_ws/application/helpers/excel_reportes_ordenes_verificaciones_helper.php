...
function excel_reportes_ordenes_verificaciones($datos)
{
    ...
    $queryCoor = $CI->db->query("select * from vw_verificaciones where orden_id = $orden_id");
    ...
    $activeWorksheet->setCellValue('I12', $num_orden);

    $activeWorksheet->getStyle('A12:F' . ($numero_row + 12))->applyFromArray($style);
    $activeWorksheet->getStyle('I12')->applyFromArray($style);
    $activeWorksheet->getStyle('G12:H' . ($numero_row + 12))->applyFromArray($style_center);
    $activeWorksheet->getStyle('I13:I' . ($numero_row + 100))->applyFromArray($style_nada);
